...
Besides the coordinates that atlases deployed, HERBS has its Internal coordinates also. In this page, I will brifely talk about the differences in coordinates between popular atlases and HERBS internal.
...
For example, the 25um atlas volume in HERBS 3D has original shape (528, 320, 456) and HERBS internal shape (456, 528, 320). If Bregma is not set specifically, HERBS will set it to be (263, 0, 228) in Allen original, which is equivalent to HERBS 2D internal (0, 228, 263).